...
function RouteComponent() {
    ...
    const { data: jobs, refetch: refetchJobs } =
        useSuspenseQuery(jobsQueryOptions);
    ...
    return (
        ...
        >
            ...
            <Typography variant="body1">
                This page is for debugging the redis jobs that are currently
                running or queued. Was create to check if our live updates with
                sockets are propagating and invalidate the correct queries.
            </Typography>
            <Button
                onClick={async () => {
